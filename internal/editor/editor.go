...
//
// The function takes the prog argument, which can be `vim` or `nano`, for
// instance. The second argument, fname, is a pointer to a string. A non-empty
// string would mean that a permanent file will be created. A nil pointer would
// mean that a temporary file will be created.
